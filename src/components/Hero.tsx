    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden cyber-grid">
      ...
      <div className="container relative z-10 px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* CTA Buttons */}
          <div className="animate-fade-up-delay-3 relative max-w-lg mx-auto mb-6 rounded-2xl border-2 border-amber-400/40 bg-gradient-to-br from-amber-400/10 via-amber-500/5 to-transparent p-5 backdrop-blur-sm shadow-[0_0_30px_hsl(45_100%_50%/0.08)]">

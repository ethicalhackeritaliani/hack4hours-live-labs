  ...
  return (
    <div className="rounded-3xl border border-border bg-card overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg, ${accentHsl} 0%, hsl(var(--card)) 70%)`,
        }}
      >
        <span
          className={`inline-block px-4 py-1 rounded-full text-sm font-mono mb-4 ${badgeColor}`}
        >
          {badge}
        </span>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {tools.map((tool) => (
              <span
                key={tool}
                className="px-3 py-1.5 rounded-lg bg-muted border border-border font-mono text-sm text-foreground"
              >
                {tool}
              </span>
            ))}
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {missions.map((mission, index) => (
              <div
                key={index}
                className="group p-5 rounded-xl bg-background border border-border hover:border-primary/30 transition-all duration-300"
              >
        ...
        <div className="text-center pt-4">
          <div className="relative max-w-lg mx-auto mb-6 rounded-2xl border-2 border-amber-400/40 bg-gradient-to-br from-amber-400/10 via-amber-500/5 to-transparent p-5 backdrop-blur-sm shadow-[0_0_30px_hsl(45_100%_50%/0.08)]">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-7 h-7 rounded-full bg-amber-400 text-background font-bold text-sm flex items-center justify-center">
                  1
                </span>
                <p className="text-foreground text-sm leading-relaxed">
                  Clicca su{" "}
                  <strong className="text-amber-400">"Registrati Ora"</strong>{" "}
                  per scoprire le{" "}
                  <strong className="text-amber-400">date disponibili</strong> e
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-foreground text-sm leading-relaxed">
                  Solo dopo la registrazione potrai procedere con il{" "}
                  <strong className="text-amber-400">pagamento</strong>
                </p>
              </div>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              variant="cyber"
              size="xl"
              className="group border-amber-400 text-amber-400 hover:bg-amber-400/10 hover:shadow-[0_0_20px_hsl(45_100%_50%/0.3)]"
              asChild
            >
              <a
...
const eventsData: EventCardProps[] = [
    ...
    missions: [
      {
        ...
        description:
          "Scansionerai una rete e identificherai servizi e versioni.",
      },
      {
        icon: Database,
        title: "Enumerazione",
      ...
      },
      {
        ...
        description:
          "Condurrai un vulnerability assessment e interpreterai i risultati.",
      },
      {
        icon: Bug,
        title: "Exploitation",
        description:
          "Eseguirai tecniche di exploitation automatizzate e non.",
      },
      {
        icon: Lock,
        title: "Brute Force",
      ...
      },
      {
        ...
        description:
          "Metterai in pratica tutte le tecniche apprese su target realistici.",
      },
    ],
  ...
  },
  {
    ...
    missions: [
      {
        icon: ScanEye,
        title: "Ricognizione AD",
        description:
          "Enumererai utenti, gruppi, GPO e relazioni di trust nel dominio.",
      },
      {
        icon: Key,
        title: "Credential Harvesting",
        description:
          "Estrarrai credenziali con tecniche di Kerberoasting e AS-REP Roasting.",
      },
      {
        icon: Network,
        title: "Lateral Movement",
        description:
          "Ti sposterai lateralmente sfruttando Pass-the-Hash e Pass-the-Ticket.",
      },
      {
        icon: ShieldAlert,
        title: "Privilege Escalation",
        description:
          "Escalerai i privilegi sfruttando misconfigurazioni e ACL vulnerabili.",
      },
      {
        icon: Server,
        title: "Domain Dominance",
        description:
          "Otterrai il controllo completo del Domain Controller con DCSync e Golden Ticket.",
      },
      {
        icon: FileText,
        title: "Post-Exploitation & Report",
        description:
          "Documenterai le vulnerabilità trovate e proporrai le remediation.",
      },
    ],
    tools: [
      "BloodHound",
...
const Eventi = () => {
  return (
    <main className="min-h-screen bg-background">
      {/* Header */}
      <section className="relative py-20 md:py-32 cyber-grid overflow-hidden">
        ...
        <div className="container relative z-10 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-sm font-mono">TORNA ALLA HOME</span>
            </Link>
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Laboratori intensivi di hacking etico, 100% pratici. Scegli il tuo
        ...
        <div className="container px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Molti altri laboratori in arrivo
            </h2>
            <p className="text-muted-foreground text-lg mb-8">
              Stiamo preparando nuovi eventi su Web Application Hacking, Wi-Fi
              Security, OSINT e molto altro. Resta connesso!
            </p>
